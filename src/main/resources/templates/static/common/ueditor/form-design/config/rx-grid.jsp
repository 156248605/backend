...
<body>
	<div class="form-outer">
			...
			<form id="miniForm">
				<table class="table-detail column_2_m" cellspacing="1" cellpadding="1">
					<tr>
						<th >备　注<span class="star">*</span></th>
						<td >
							<input id="label" class="mini-textbox" name="label" required="true" vtype="maxLength:100"  style="width:90%" emptytext="请输入子表备注" onblur="getPinyin" />
						</td>
						<th >别　名<span class="star">*</span></th>
						<td >
							<input id="name" name="name" class="mini-textbox" required="true" style="width:90%" emptytext="请输入子表别名" onvalidation="onEnglishAndNumberValidation"/>
						</td>
					</tr>
					<tr>
						<th >数据编辑模式</th>
						<td colspan="">
							<div class="mini-radiobuttonlist" id="edittype"  name="edittype" value="inline" onvaluechanged="changeEditType" data="[{id:'inline',text:'行内'},{id:'openwindow',text:'弹窗'},{id:'editform',text:'弹出表单'}]"></div>
						</td>
						<th >必　填</th>
						<td colspan="">
							<div id="requireformfield" name="requireformfield" class="mini-checkbox" ></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3" style="padding:5px;">
							...
							<div id="hdgrid" class="mini-datagrid" style="width:100%;height:250px"  showPager="false"  
							    ...
							    <div property="columns" class="border-right">
							        ...
							        <div field="datatype" width="60">数据类型
							        	<input property="editor" class="mini-combobox" value="varchar"  textField="text" valueField="id" data="[{id:'varchar',text:'字符'},{id:'number',text:'数字'},{id:'date',text:'日期型'}]">
							        </div>
	...
	<script type="text/javascript">
		...
		var controlData=[{id:'mini-textbox',text:'单行文本',tag:'input',datatype:'varchar'},
		{id:'mini-textarea',text:'多行文本',tag:'textarea',datatype:'varchar'},
		...
		dialog.onok = function (){
	        ...
	        if( !oNode ) {
	        	isCreate=true;
		            ...
		            for(var i=0;i<gridData.length;i++){
		            	...
		            	+'" class="rxc '+row.editcontrol+'" name="'+row.key+'" label="'+row.name+'" datatype="'+row.datatype+'"/>';
		            	td2.append(control);
		            	brow.append(td2);
		            }
		            thead.append(hrow);
			...
			oNode.setAttribute('data-options','{requireformfield:'+mini.get('requireformfield').getValue()+'}');
            //弹出窗口
