...
function bindEvent(){
	var data=isMain?[{id:'init',text:'初始化'},{id:'enter',text:'回车'},{id:'valuechanged',text:'值改变'}]:[{id:'valuechanged',text:'值改变'}];
...
function changeCustomquery(e){
	...
	var conditions=mini.decode(obj.whereField);
			...
			<div id="gridSetting" class="mini-datagrid" style="width:100%;height:100%;" showPager="false" 
			    ...
			    >
				    <div property="columns">
				        ...
				        <div name="action" cellCls="actionIcons" renderer="onActionRenderer"  headerAlign="center" align="center" >操作</div>
				    </div>
			</div>
		</div>
		<div title="自定义查询配置" region="center"  showHeader="false" >
			...
			<table id="formSetting" class="table-detail column_2_m" cellspacing="1" cellpadding="0" style="width:100%;">
				<tr>
					...
					<th>事　件</th>
					<td >
						<input id="event" name="event" class="mini-checkboxlist"   textField="text" valueField="id" 
    						data="[{id:'init',text:'初始化'},{id:'enter',text:'回车'},{id:'valuechanged',text:'值改变'}]" value="" showNullItem="true"/>
					</td>
						...
						allowCellEdit="true" allowCellSelect="true" oncellbeginedit="gridReturnBeginEdit" height="150">
						    <div property="columns">
						        ...
						        <div field="mapVal"   headerAlign="center" allowSort="true"  >映射值
						        	<input property="editor"  class="mini-combobox"  valueField="name" textField="comment"  />
						        </div>    
						    </div>
						</div>
					</td>
