					...
					<tr id="valueFrom">
						...
						<td colspan="3">
							<div id="valueFromBox_sequence" style="display: none;">
								...
								<input id="sequence" name="sequence" class="mini-lookup" style="width: 200px;" textField="alias" valueField="seqId" popupWidth="auto" popup="#gridPanel" grid="#datagrid1" multiSelect="false" value="" text="" />
								...
								<div id="gridPanel" class="mini-panel" title="header" iconCls="icon-add" style="width: 480px; height: 280px;" showToolbar="true" showCloseButton="true" showHeader="false" bodyStyle="padding:0" borderStyle="border:0">
									...
									<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 100%;" borderStyle="border:0" showPageSize="false" showPageIndex="false" url="${ctxPath}/sys/core/sysSeqId/getInstAllSeq.do" multiSelect="false" pageSize="15">
