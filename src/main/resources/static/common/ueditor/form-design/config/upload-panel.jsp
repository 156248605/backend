			...
			<form id="miniForm">
				<table class="table-detail column_2_m" cellspacing="1" cellpadding="1">
					...
					<tr>
						...
						<th>附件名</th>
						<td><input id="name" name="name" class="mini-textbox" style="width:150px" valueField="id"   required="true"  onvalidation="onEnglishAndNumberValidation"/></td>				
					</tr>
					<tr>
						...
						<th>上传 大小限制（MB）<span class="star">*</span></th>
						<td >
							<input id="sizelimit" class="mini-textbox" value="50" name="sizelimit" required="true" vtype="maxLength:20"  style="width:60px" emptytext="输入大小限制"   />
						</td>
					</tr>
					<tr>
						<th>单一附件</th>
