 ...
 */
@Mapper
public interface IHRsetSsbgrcdDao {
    /**
     *@Author:ShiYun;
     *@Description:添加一条信息
     *@Date: 18:35 2018\5\11 0011
     */
    public Integer insertOne(HRsetSsbgrcd hRsetSsbgrcd);
     ...
     */
    public List<HRsetSsbgrcd> selectAll();
     ...
     */
    public List<HRsetSsbgrcd> selectByConditions(HRsetSsbgrcd hRsetSsbgrcd);
     ...
     */
    public void updateOne(HRsetSsbgrcd hRsetSsbgrcd);
}
