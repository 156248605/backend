...
public interface IHRsetByyxDao {
     ...
     */
    public Integer insertOne(HRsetByyx hRsetByyx);
     ...
     */
    public List<HRsetByyx> selectAll();
     ...
     */
    public List<HRsetByyx> selectByConditions(HRsetByyx hRsetByyx);
     ...
     */
    public void updateOne(HRsetByyx hRsetByyx);
}
