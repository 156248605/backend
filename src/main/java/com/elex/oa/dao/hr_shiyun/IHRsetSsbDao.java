 ...
 */
@Mapper
public interface IHRsetSsbDao {
    /**
     *@Author:ShiYun;
     *@Description:添加一条信息
     *@Date: 18:35 2018\5\11 0011
     */
    public Integer insertOne(HRsetSsb hRsetSsb);
     ...
     */
    public List<HRsetSsb> selectAll();
     ...
     */
    public List<HRsetSsb> selectByConditions(HRsetSsb hRsetSsb);
     ...
     */
    public void updateOne(HRsetSsb hRsetSsb);
}
