 ...
 */
@Mapper
public interface IHRsetTelphoneDao {
    /**
     *@Author:ShiYun;
     *@Description:添加一条信息
     *@Date: 18:35 2018\5\11 0011
     */
    public Integer insertOne(HRsetTelphone hRsetTelphone);
     ...
     */
    public List<HRsetTelphone> selectAll();
     ...
     */
    public List<HRsetTelphone> selectByConditions(HRsetTelphone hRsetTelphone);
     ...
     */
    public void updateOne(HRsetTelphone hRsetTelphone);
}
