...
public interface Commons {
    ...
    String CLUE_ON = "跟踪";
    String CLUE_OFF = "关闭";
    String CLUE_TRANSFOR_OPPORTUNITY = "转商机";
    String OPPORTUNITY_ON = "跟踪";
    String OPPORTUNITY_OFF = "关闭";
    String OPPORTUNITY_TRANSFOR_PROJECT = "转立项";
    Integer EMPLOYEE_ON = 1;//员工在职状态
