...
/**
 * @Author:ShiYun;
 * @Description:JSON模板(共18种情况)
 * @Date:Created in  19:40 2018\6\15 0015
 * @Modify By:
 */
public class JsonTool {
    ...
    /**
     * 2.1.1-A.json字符串-简单对象型到JSONObject的转换
     */
    ...
    /**
     * 2.1.1-B.JSONObject到json字符串-简单对象型的转换
     */
    ...
    /**
     * 2.1.2-A.json字符串-数组类型到JSONArray的转换
     */
    ...
    /**
     * 2.1.2-B.JSONArray到json字符串-数组类型的转换
     */
    ...
    /**
     * 2.1.3-A.复杂json格式字符串到JSONObject的转换
     */
    ...
    /**
     * 2.1.3-B.复杂JSONObject到json格式字符串的转换
     */
    ...
    /**
     * 2.2.1-A.json字符串-简单对象到JavaBean之间的转换
     */
    ...
    /**
     * 2.2.1-B.JavaBean到json字符串-简单对象的转换
     */
    ...
    /**
     * 2.2.2-A.json字符串-数组类型到JavaBean_List的转换
     */
    ...
    /**
     * 2.2.2-B.JavaBean_List到json字符串-数组类型的转换
     */
    ...
    /**
     * 2.2.3-A.复杂json格式字符串到JavaBean_obj的转换
     */
    ...
    /**
     * 2.2.3-B.复杂JavaBean_obj到json格式字符串的转换
     */
    ...
    /**
     * 2.3.1-A.简单JavaBean_obj到json对象的转换
     */
    ...
    /**
     * 2.3.1-B.简单json对象到JavaBean_obj的转换
     */
    ...
    /**
     * 2.3.3-A复杂JavaBean_obj到json对象的转换
     */
    ...
    /**
     * 2.3.3-B复杂json对象到JavaBean_obj的转换
     */
