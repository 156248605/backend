...
/*    public static void addCookie(String name, String value, int maxAge, boolean httpOnly, PageContext context) {
    ...
    public static void addCookie(String name, String value, int maxAge, boolean httpOnly, HttpServletRequest req, HttpServletResponse response) {
